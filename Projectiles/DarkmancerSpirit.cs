...
{
    public class DarkmancerSpirit : ModProjectile
    {
        ...
        {
            Dust.NewDustPerfect(projectile.Center, 180, projectile.velocity).noGravity = true;
        }
        ...
        {
            NPC npc = Depth.NearestNPC(projectile.Center, 200f, false, false);
